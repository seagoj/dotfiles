...
# Browser
export BROWSER=$(which firefox-developer-edition firefox surf chromium-browser chromium google-chrome google-chrome-stable chrome browsh links2 links lynx xdg-open open | grep -m1 -e '^/')
# Editor
