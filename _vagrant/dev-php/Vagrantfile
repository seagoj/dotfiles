Vagrant::Config.run do |config|
  ...
  cookbooks = {
    ...
    'lib::bootstrap'=>'git@github.com:seagoj/cookbook-lib.git',
    'lib::predis'=>'git@github.com:seagoj/cookbook-lib.git',
    'lib::devtools'=>'git@github.com:seagoj/cookbook-lib.git'
